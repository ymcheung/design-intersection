...
export default function Translator() {
  ...
  <>
    ...
    <figure className="d:grid grid-template-columns:80|1fr gap-x:16 margin:0|0|16">
      ...
      <figcaption>
        ...
        <span className="block margin-bottom:6 color:shade-500  f:14 line-height:1">網站前端開發 @RE:LAB</span>
